...
# Database: ap4
# Generation Time: 2024-02-14 15:18:21 +0000
# ************************************************************
...
INSERT INTO `users` (`id_u`, `lastname_u`, `firstname_u`, `email_u`, `password`, `role`)
VALUES
	(1,'ITH','Kagnana','ikagnana@gmail.com','admin',0);
