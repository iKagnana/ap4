...
<div class="page-container">
    <div class="flex-col-container">
        <?php echo "<form class='m-1' action=$host/product>"; ?>
        ...
        <?php echo "<form class='form-center-item' action=$host/product/update method=post>"; ?>
        <?php
        ...
        <?php echo "<form action=$host/product/delete method=post>"; ?>
        <?php
        $product = $data["selected"];
        echo "<input hidden name='id' value=$product->id>"
            ?>
